...
export type TypePageLandingWithoutLinkResolutionResponse = TypePageLanding<"WITHOUT_LINK_RESOLUTION", string>;
export type TypePageLandingWithoutUnresolvableLinksResponse = TypePageLanding<"WITHOUT_UNRESOLVABLE_LINKS", string>;
